        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/services" className="text-gray-400 hover:text-red-600 transition-colors duration-300 text-lg">Services</a></li>
              <li><a href="/about" className="text-gray-400 hover:text-red-600 transition-colors duration-300 text-lg">About Us</a></li>
              <li><a href="/gallery" className="text-gray-400 hover:text-red-600 transition-colors duration-300 text-lg">Gallery</a></li>
              <li><a href="/contact" className="text-gray-400 hover:text-red-600 transition-colors duration-300 text-lg">Contact</a></li>
            </ul>
          </div>
