...
function Navbar({ user, setUser }) { // add setUser to clear state
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="/dashboard" className="text-white hover:text-red-600 font-semibold transition-colors duration-300">
              Dashboard
            </a>
            <a href="/services" className="text-white hover:text-red-600 font-semibold transition-colors duration-300">
              Services
            </a>
            <a href="/bookings" className="text-white hover:text-red-600 font-semibold transition-colors duration-300">
              My Bookings
            </a>
            <a href="/history" className="text-white hover:text-red-600 font-semibold transition-colors duration-300">
              History
            </a>
          </div>
          ...
          <div className="relative">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-64 bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl shadow-2xl border border-gray-700 overflow-hidden">
                ...
                <div className="py-2">
                  <a href="/profile" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white transition-colors duration-300">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    <span>My Profile</span>
                  </a>
                  <a href="/settings" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white transition-colors duration-300">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="/help" className="flex items-center gap-3 px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white transition-colors duration-300">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
