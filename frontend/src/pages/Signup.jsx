...
function SignUpPage() {
  ...
  const validateStep = (step) => {
    ...
    if (step === 1) {
      // Validate Personal Information (Name)
      ...
      // Validate Account Security (Password & Terms)
            ...
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 md:p-12 border border-gray-700 shadow-2xl">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center w-full">
                  <div className={`flex items-center ${currentStep >= 1 ? 'text-red-600' : 'text-gray-500'}`}>
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 
                      ${currentStep >= 1 ? 'border-red-600 bg-red-600 text-white' : 'border-gray-600 text-gray-500'}`}>
                      1
                    </div>
                    <span className="ml-2 text-sm font-medium hidden sm:block">Personal</span>
                  </div>
                  <div className={`flex-1 h-1 mx-4 ${currentStep >= 2 ? 'bg-red-600' : 'bg-gray-700'}`}></div>
                  <div className={`flex items-center ${currentStep >= 2 ? 'text-red-600' : 'text-gray-500'}`}>
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 
                      ${currentStep >= 2 ? 'border-red-600 bg-red-600 text-white' : 'border-gray-600 text-gray-500'}`}>
                      2
                    </div>
                    <span className="ml-2 text-sm font-medium hidden sm:block">Contact</span>
                  </div>
                  <div className={`flex-1 h-1 mx-4 ${currentStep >= 3 ? 'bg-red-600' : 'bg-gray-700'}`}></div>
                  <div className={`flex items-center ${currentStep >= 3 ? 'text-red-600' : 'text-gray-500'}`}>
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 
                      ${currentStep >= 3 ? 'border-red-600 bg-red-600 text-white' : 'border-gray-600 text-gray-500'}`}>
                      3
                    </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  {currentStep < 3 ? (
                    <button
                      type="button"
                      onClick={handleNext}
                      className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-4 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-red-600/50"
                    >
                      Next
                    </button>
                  ) : (
