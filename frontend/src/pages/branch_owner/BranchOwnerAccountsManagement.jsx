      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-red-950/30 -m-4 sm:-m-8 p-4 sm:p-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6 sm:mb-8">
          {roles.map((role) => (
            <div
              key={role}
              className="bg-white dark:bg-gray-900/60 border border-gray-200 dark:border-white/5 rounded-2xl p-3 sm:p-4 backdrop-blur-sm hover:border-gray-300 dark:hover:border-white/10 transition-all cursor-pointer shadow-sm dark:shadow-none"
