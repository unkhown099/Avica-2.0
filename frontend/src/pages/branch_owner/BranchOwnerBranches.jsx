        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {branches.map((branch, index) => (
            ...
            >
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    className={`h-3 rounded-full transition-all duration-300 ${
                      branch.bayUtilization >= 80
                        ? "bg-emerald-500"
                        : branch.bayUtilization >= 60
                          ? "bg-yellow-500"
                          : "bg-red-500"
                    }`}
              ...
              {/* Action Button */}
              <button className="w-full px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition-colors duration-200 shadow-sm">
                View Details
              </button>
            </div>
          ))}
