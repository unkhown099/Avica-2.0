...
function CloseBtn({ onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-white/5 hover:bg-white/10 text-gray-500 hover:text-white transition-colors flex items-center justify-center flex-shrink-0"
    >
      <svg
  ...
  return (
    <div className="flex items-center justify-center gap-1 mt-6 sm:mt-8 flex-wrap">
      <button
        ...
        disabled={current === 1}
        className="w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center rounded-xl border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:border-red-500/50 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
      >
        <svg
        ...
        {pages.map((p) => {
          ...
          return (
            <button
              key={p}
              onClick={() => onChange(p)}
              className={`w-7 h-7 sm:w-9 sm:h-9 flex items-center justify-center rounded-xl text-xs font-bold transition-all ${p === current ? "bg-red-600 text-white shadow-lg shadow-red-600/30 border border-red-500" : "border border-white/10 bg-white/5 text-gray-400 hover:text-white hover:border-red-500/50"}`}
            >
              {p}
            </button>
          );
        ...
        return (
          <React.Fragment key={label}>
            <div className="flex flex-col items-center gap-1 flex-shrink-0">
              <div
                className={`w-5 h-5 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-[9px] sm:text-xs font-black transition-all duration-300 ${done ? "bg-red-600 text-white" : active ? "bg-red-600/20 border-2 border-red-500 text-red-400" : "bg-white/5 border border-white/10 text-gray-600"}`}
              >
                {done ? (
                  <svg
    ...
    <CenterModal onClose={onClose}>
        ...
        <div>
          ...
          <div className="space-y-1.5">
            {cancelReasons.map((r) => (
              <label
                key={r}
                className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3 rounded-xl border border-white/10 bg-white/3 hover:bg-white/5 cursor-pointer transition-all"
              >
                <input
                  type="radio"
                  name="cancelReason"
      ...
      <div className="flex gap-2 sm:gap-3 px-4 sm:px-6 py-4 border-t border-white/8 flex-shrink-0 bg-[#0a0a0a]">
        ...
        <button
          ...
          className="flex-1 py-2 sm:py-3 rounded-xl bg-red-600 hover:bg-red-700 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold text-xs sm:text-sm shadow-lg shadow-red-600/25 transition-all flex items-center justify-center gap-1.5"
        >
          {loading ? (
            <>
              <svg
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-5">
        {!analysisResult ? (
          <>
            ...
            <div
              className="border-2 border-dashed border-white/10 rounded-2xl p-5 sm:p-6 text-center hover:border-red-500/50 transition-colors cursor-pointer mb-4 sm:mb-6"
                  ...
                  {images.map((img, i) => (
                    <div key={i} className="relative group">
                      ...
                      <button
                        ...
                        className="absolute top-1 right-1 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-red-600/90 hover:bg-red-700 text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                      >
                        <svg
      ...
      <div className="flex gap-2 sm:gap-3 px-4 sm:px-6 py-4 border-t border-white/8 flex-shrink-0 bg-[#0a0a0a]">
        ...
        {!analysisResult ? (
          <button
            ...
            className="flex-1 py-2 sm:py-3 rounded-xl bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-1.5"
          >
            {uploading ? (
              <>
                <svg
          ...
          <button
            ...
            className="flex-1 py-2 sm:py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-1.5"
          >
            Proceed to Booking
            <svg
...
function NewBookingModal({
  ...
  const canAdvance = () => {
    ...
    if (step === 3) {
      ...
      if (form.date <= todayISO()) {
        setError(
          "Same-day bookings are not allowed. Please select tomorrow or later.",
        );
        return false;
      }
      if (hasActiveBooking) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (form.date <= todayISO())
        throw new Error("Same-day bookings are not allowed.");
      if (hasActiveBooking)
        ...
        {step === 0 && (
          <div>
                ...
                {categoriesLoading ? (
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg border text-[10px] sm:text-xs font-semibold transition-all ${selectedCategory === "all" ? "border-red-500 bg-red-600/15 text-red-300" : "border-white/10 bg-white/5 text-gray-400 hover:text-white"}`}
                    >
                      All
                    </button>
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (
                            ...
                            ).toLowerCase() !== String(cat).toLowerCase()
                          )
                            set("service", null);
                        }}
                        className={`px-2.5 py-1 rounded-lg border text-[10px] sm:text-xs font-semibold transition-all ${String(selectedCategory).toLowerCase() === String(cat).toLowerCase() ? "border-red-500 bg-red-600/15 text-red-300" : "border-white/10 bg-white/5 text-gray-400 hover:text-white"}`}
                      >
                        {cat}
                      </button>
                    ))}
            ...
            {servicesLoading ? (
              ...
              /* MOBILE: compact list; SM+: 2-col grid */
              <>
                {/* Mobile compact list */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {[
                ...
                <button
                  ...
                  className={`p-3 sm:p-4 rounded-2xl border text-left transition-all ${bookingMode === key ? `border-${accent}-500 bg-${accent}-600/10` : "border-white/8 bg-white/3 hover:border-white/15"}`}
                >
                    ...
                    {employees.map((emp) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-3 rounded-xl border text-left transition-all ${active ? "border-red-500 bg-red-600/12" : "border-white/8 bg-white/3 hover:border-white/15"}`}
                        >
        ...
        {step === 3 && (
          <div className="space-y-4">
            <div>
              <p className="text-[10px] sm:text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">
                Pick a Date{" "}
                <span className="text-yellow-500 font-normal normal-case text-[9px] sm:text-[10px]">
                  (Tomorrow or later)
                </span>
              </p>
              <input
              ...
              {form.date && form.date <= todayISO() && (
                <p className="text-yellow-500 text-[9px] sm:text-[10px] mt-1">
            ...
            <div>
                ...
                {visibleTimeSlots.map((t) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={isDisabled}
                      className={`py-2 sm:py-3 rounded-xl border text-[10px] sm:text-sm font-bold transition-all ${active && !isDisabled ? "border-red-500 bg-red-600/15 text-white shadow-md shadow-red-600/10" : isDisabled ? "border-white/5 bg-white/3 text-gray-600 cursor-not-allowed opacity-40" : "border-white/8 bg-white/3 text-gray-400 hover:border-white/20 hover:text-white cursor-pointer"}`}
                    >
                      {t}
                      {isDisabled &&
                        slotsLoaded &&
              ...
              {form.date &&
                ...
                availableSlots !== null &&
                !hasActiveBooking && (
                  <p className="text-gray-500 text-[9px] sm:text-[10px] mt-2">
                    {availableCount > 0
            ...
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  className={`w-full bg-white/5 border rounded-xl px-3 sm:px-4 py-2 sm:py-3 text-white text-xs sm:text-sm placeholder-gray-600 focus:outline-none focus:border-red-500 transition-colors ${fieldErrors[key === "plateNumber" ? "plate_number" : key] ? "border-red-500" : "border-white/10"}`}
                />
                {fieldErrors[key === "plateNumber" ? "plate_number" : key] && (
                  <p className="text-red-400 text-[9px] sm:text-[10px] mt-1">
                    {fieldErrors[key === "plateNumber" ? "plate_number" : key]}
                  </p>
                )}
      ...
      <div className="flex gap-2 sm:gap-3 px-4 sm:px-6 py-4 border-t border-white/8 flex-shrink-0 bg-[#0a0a0a]">
        ...
        {step < STEPS.length - 1 ? (
          <button
            type="button"
            onClick={handleNext}
            className="flex-1 py-2 sm:py-3 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs sm:text-sm shadow-lg shadow-red-600/25 transition-all flex items-center justify-center gap-1.5"
          >
            Continue
            <svg
              className="w-3.5 h-3.5"
          ...
          <button
            ...
            onClick={handleSubmit}
            disabled={loading}
            className="flex-1 py-2 sm:py-3 rounded-xl bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold text-xs sm:text-sm shadow-lg shadow-red-600/25 transition-all flex items-center justify-center gap-1.5"
          >
            {loading ? (
              <>
                <svg
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-red-950/30 p-3 sm:p-5 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 sm:mb-8">
          ...
          <button
            ...
            className="self-start sm:self-auto bg-red-600 hover:bg-red-700 text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-xl transition-all hover:scale-105 shadow-xl shadow-red-600/30 flex items-center gap-1.5 text-xs sm:text-sm"
          >
            <svg
        ...
        {/* ── Summary Cards — 2-col mobile, 5-col sm+ ── */}
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 sm:gap-3 mb-5 sm:mb-8">
          {summaryCards.map(({ label, value, color }) => (
            ...
            >
              <div
                className={`text-xl sm:text-2xl lg:text-3xl font-black ${color} mb-0.5`}
              >
                {value}
              </div>
        ...
        <div className="flex gap-1.5 mb-4 sm:mb-6 overflow-x-auto no-scrollbar pb-1">
          {["all", "confirmed", "pending", "done", "cancelled"].map((f) => (
            <button
              key={f}
              onClick={() => setFilter(f)}
              className={`flex-shrink-0 px-3 sm:px-5 py-1.5 sm:py-2 rounded-xl font-semibold text-[10px] sm:text-xs capitalize transition-all ${filter === f ? "bg-red-600 text-white shadow-lg shadow-red-600/30" : "bg-gray-900 text-gray-400 border border-white/10 hover:text-white hover:border-red-600/40"}`}
            >
              {f}
            </button>
          ))}
          ...
          {!loading &&
            ...
            paginated.map((booking) => {
              ...
              return (
                <div
                  key={booking.id}
                  className="bg-gradient-to-br from-gray-900 to-red-950/10 rounded-2xl border border-white/5 hover:border-red-600/30 transition-all duration-300 overflow-hidden"
                >
                  ...
                  <div className="sm:hidden">
                    ...
                    <div className="flex items-center justify-between px-4 pt-4 pb-2">
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded-full text-[8px] font-bold border flex-shrink-0 ${sc.color}`}
                        >
                          {sc.label}
                        </span>
                      </div>
                      <div className="text-base font-black text-white ml-3 shrink-0">
                        {priceDisplay}
                      </div>
                    </div>

                    {/* Meta row */}
                    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 px-4 pb-3 text-gray-400 text-[10px]">
                      ...
                      booking.status !== "done" && (
                        <div className="border-t border-white/5 px-4 py-2.5 flex justify-end">
                          <button
                            ...
                            className="px-3 py-1.5 bg-red-600/20 hover:bg-red-600 border border-red-600/40 text-red-400 hover:text-white rounded-lg text-[10px] font-semibold transition-all"
                          >
                            Cancel Booking
                          </button>
                        </div>
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3 flex-wrap">
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-[10px] font-bold border ${sc.color}`}
                          >
                            {sc.label}
                          </span>
                        </div>
                        <div className="flex flex-wrap gap-x-5 gap-y-2 text-gray-400 text-xs">
                          {[
                            {
                              icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
                              text: booking.date,
                      ...
                      <div className="flex items-center justify-end gap-4">
                        ...
                        {booking.status !== "cancelled" &&
                          booking.status !== "done" && (
                            <button
                              onClick={() => setCancelBooking(booking)}
                              className="px-4 py-2 bg-red-600/20 hover:bg-red-600 border border-red-600/40 text-red-400 hover:text-white rounded-xl text-xs font-semibold transition-all duration-200"
                            >
                              Cancel
                            </button>
                          )}
